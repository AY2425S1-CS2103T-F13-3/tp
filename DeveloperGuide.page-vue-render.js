...
with(this){return _c('p',[_c('strong',[_v("Name: UC01 - Create Contact (Vendor/Client)")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Compatibility: Should work on any "),_c('em',[_v("mainstream OS")]),_v(" (Windows/macOS/Linux) as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Compatibility: The system should be usable on both desktop (Windows/macOS)")]),_v(" "),_c('li',[_v("Compatibility: The system should work on both 32-bit and 64-bit environments.")]),_v(" "),_c('li',[_v("User Experience: Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("User Experience: The system should respond within two seconds.")]),_v(" "),_c('li',[_v("User Experience: A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Privacy: User data must remain on the local machine and not be shared or transmitted to any external services unless explicitly requested by the user (e.g., exporting contacts).")]),_v(" "),_c('li',[_v("Portability: The system should allow easy exporting of data to be imported into other applications if needed.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Vendor")]),_v(": A person who provides certain kinds of services")]),_v(" "),_c('li',[_c('strong',[_v("32-bit and 64-bit environment")]),_v(": The amount of memory that your computer can address. 64-bit machines are able to access much more memory than 32-bit machines.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Wed, 2 Oct 2024, 23:04:17 GMT+8]")])])])}
}];
